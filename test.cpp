...
/*
assert that that read_int returns the EMPTY_NUM_EXPR_ERROR code for the given input string.
*/
static void assert_empty(const char *input)
{
    ...
    printf("SUCCESS: read_int(%s,&value) returns empty numerical expression error code.\n",input);
}

/*
assert that that read_int returns the OUT_OF_BOUNDS_ERROR code for the given input string.
*/
...
/*
assert that that read_int returns the OVERFLOW_ERROR code for the given input string.
*/
...
/*
assert that read_int returns the INT_SCANNED code for the given input string and the value is set to expected_val
*/
